...
class ToDoDataBase {
  ...
  void createInitialData() {
    toDoList = [
      ...
      ["Potato Soup (grilled chz for girls)", false],
      ["Chicken and rice soup", false],
      ["Tomato Soup and grilled cheese", true],
      ...
      ["Chicken Sandwiches and curly fries", true],
      ...
      ["Chicken casserole w/ dinner rolls", true],
      ...
      ["Orange Chicken, basmati and corn", true],
      ["Beef & Broccoli Stir-Fry", false],
      ["Dumplings", false],
      ["Chicken salad bar (boiled eggs)", false],
      ["Steak nachos", false],
      ["Grilled steak, veggies, fingerling potatoes", false],
